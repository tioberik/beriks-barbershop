        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
            <form method="POST" action="/products" enctype="multipart/form-data">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <textarea id="description" name="description" rows="3"
                                        class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-500 sm:text-sm sm:leading-6"
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input type="text" name="price" id="price" autocomplete="price"
                                            class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                            placeholder="30,00" value="{{old('price')}}" required>
                                    </div>
                                </div>
                                @error('price')
                                    <p class="text-xs text-red-500 font-semibold py-2">*{{$message}}</p>
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input type="text" name="discount_price" id="discount_price"
                                            autocomplete="discount_price" value="{{old('discount_price')}}"
                                            class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                            placeholder="30,00">
                                    </div>
                                </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit"
                        class="rounded-md bg-orange-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500">Save</button>
                </div>
            </form>
